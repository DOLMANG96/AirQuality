...
import com.cho.airquality.databinding.ActivityMainBinding
import com.cho.airquality.retrofit.AirQualityResponse
import com.cho.airquality.retrofit.AirQualityService
import com.cho.airquality.retrofit.RetrofitConnection
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getAirQualityData(latitude: Double, longitude: Double) { // 레트로핏 객체를 이용하면 AirQualityService 인터페이스 구현체를 가져올 수 있습니다.
        ...
        retrofitAPI.getAirQualityData(
            latitude.toString(), longitude.toString(), "3bc1cdcd-ded7-4f8f-a540-7dcc1cf150e2"
    ...
    private fun getCurrentAddress(latitude : Double, longitude : Double) : Address?{
        ...
        try {
            ...
            Toast.makeText(this,"geocoder 서비스를 이용불가 합니다.",Toast.LENGTH_LONG).show()
            return null
